...
class DQNAgent(object):
    def __init__(self, gamma, learning_rate, epsilon, memory_size, batch_size,
        ...
        self.policy_net = GNNDQN(num_inputs_sn, num_inputs_vnr, hidden_size, GCN_out, learning_rate, num_actions).to(self.device)
        self.target_net = GNNDQN(num_inputs_sn, num_inputs_vnr, hidden_size, GCN_out, learning_rate, num_actions).to(self.device)
